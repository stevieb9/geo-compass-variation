...
Magnetic::Declination - Accurately calculate magnetic declination and inclination

=head1 SYNOPSIS

     use Magnetic::Declination qw(mag_dec mag_inc);
...
All functions must be imported explicitly:
     ...
     use Magnetic::Declination qw(:all);
